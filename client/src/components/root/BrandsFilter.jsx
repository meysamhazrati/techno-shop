        ...
        {isBrandsError ? (
          ...
          <div key={_id} className="flex items-center gap-x-3">
            <input
              ...
              onChange={({ target }) => setFilter((brands) => target.checked ? [...brands, englishName.toLowerCase().split(" ").join("-")] : brands.filter((brand) => brand !== englishName.toLowerCase().split(" ").join("-")))}
            />
            <div className="flex w-full items-center justify-between gap-x-3">
